...
import AutocompleteUsersProvider from './AutocompleteUsersProvider'
import AutocompleteChannelsProvider from './AutocompleteChannelsProvider'
...
export default {
  ...
  activate(serializedState) {
    ...
    // setup propviders
    this.usersProvider = new AutocompleteUsersProvider(this)
    this.channelsProvider = new AutocompleteChannelsProvider(this)
